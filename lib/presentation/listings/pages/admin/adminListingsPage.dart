...
class admin_listings_page extends StatefulWidget {
  static String id = 'admin_listings_screen';

  const admin_listings_page({super.key});

  @override
  State<admin_listings_page> createState() => _admin_listings_pageState();
}

class _admin_listings_pageState extends State<admin_listings_page> {
  void _showDialog(){
    showDialog(
        context: context,
        builder: (context){
