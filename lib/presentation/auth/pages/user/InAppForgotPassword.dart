...
class Inappforgotpassword extends StatefulWidget {
  const Inappforgotpassword({super.key});

  @override
  State<Inappforgotpassword> createState() => _Inappforgotpassword();
}

class _Inappforgotpassword extends State<Inappforgotpassword> {
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),
                      InputField(obscureText: false, textfieldWidth: double.infinity, hintText: 'e.g daniel@gmail.com', inputType: TextInputType.emailAddress, controller_: emailController,),
                      SizedBox(height: 20,),
                      Buttons(
                        ...
                        onPressed: ()async{
                          ...
                          if(emailController.text.trim().isNotEmpty){
                            if(emailController.text.trim() == userProvider?.currentUser?.email){
