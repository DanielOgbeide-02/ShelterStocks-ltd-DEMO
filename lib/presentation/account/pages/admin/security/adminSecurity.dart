...
import 'package:shelterstocks_prototype2/presentation/auth/pages/admin/AdminInAppForgotPassword.dart';
...
class Adminsecurity extends StatefulWidget {
  ...
  const Adminsecurity({super.key});

  @override
  State<Adminsecurity> createState() => _AdminsecurityPage();
}

class _AdminsecurityPage extends State<Adminsecurity> with WidgetsBindingObserver{
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> Admininappforgotpassword()));
                    },
                    child: Container(
