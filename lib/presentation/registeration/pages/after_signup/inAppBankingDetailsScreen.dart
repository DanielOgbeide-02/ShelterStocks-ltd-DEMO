...
import '../../../account/pages/user/AccountPage.dart';
import 'package:http/http.dart' as http;



class inAppBankingdetailsScreen extends StatefulWidget {
  static String id = 'inAppBanking_screen';
  const inAppBankingdetailsScreen({super.key});

  @override
  State<inAppBankingdetailsScreen> createState() => _inAppBankingdetailsScreenState();
}

class _inAppBankingdetailsScreenState extends State<inAppBankingdetailsScreen> {
