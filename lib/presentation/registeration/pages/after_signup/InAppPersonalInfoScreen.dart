...
class inAppPersonalInfoScreen extends StatefulWidget {
  static String id = 'inAppPersonalInfo_screen';
  const inAppPersonalInfoScreen({super.key});

  @override
  State<inAppPersonalInfoScreen> createState() => _inAppPersonalInfoScreenState();
}
  List<String> marritalStatus = ['Single', 'Married'];
class _inAppPersonalInfoScreenState extends State<inAppPersonalInfoScreen> {
                           ...
                           Container(
                             child: Row(
                               children: [
                                 Expanded(
                                   child: Buttons(
                                     width: 50.w, isPressed:isPressed,height: 45.h, buttonText: 'Cancel', buttonColor: Color(0xFF1A1AFF), buttonTextColor: Colors.white,isLoading: isLoading,
                                     onPressed: (){
                                         setState(() {
                                           isPressed = true;
                                           isLoading = true;
                                     ...
                                     onPressed: () async {
                                       if(isConnectedToInternet){
                                         ...
                                         if(currentMaritalStatus.isNotEmpty && resAddress.isNotEmpty && phoneNo.isNotEmpty){
                                           ...
                                           Navigator.pushNamed(context, inAppIdentificationScreen.id);
                                           setState(() {
                                             isPressed = false;
                                           });
                                         }
